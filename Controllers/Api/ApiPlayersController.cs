...
namespace VolleyballFinal.Controllers.Api
{
    ...
    [ApiController]
    public class ApiPlayersController : ControllerBase
    {
        private readonly TeamContext _context;

        public ApiPlayersController(TeamContext context)
        {
            _context = context;
        }
